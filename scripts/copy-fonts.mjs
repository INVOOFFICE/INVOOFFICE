/**
 * Copie les .woff2 utilisés depuis @fontsource vers fonts/ (après npm install).
 * Exécution : npm run fonts:copy
 */
...
console.log("fonts:copy →", outDir, "(" + files.length + " fichiers)");
